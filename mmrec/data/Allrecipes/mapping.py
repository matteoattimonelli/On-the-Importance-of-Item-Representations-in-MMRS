...
visual_embeddings_folder = f'visual_embeddings_{args.batch_size}/blip2-itm-vit-g-coco'
textual_embeddings_folder = f'textual_embeddings_{args.batch_size}/blip2-itm-vit-g-coco'

visual_embeddings_folder_indexed = f'visual_embeddings_indexed_{args.batch_size}/blip2-itm-vit-g-coco'
textual_embeddings_folder_indexed = f'textual_embeddings_indexed_{args.batch_size}/blip2-itm-vit-g-coco'
...
visual_embeddings_folder = f'visual_embeddings_{args.batch_size}/vit-base-patch16-224'
textual_embeddings_folder = f'textual_embeddings_{args.batch_size}/sentence_transformers/sentence-transformers/all-mpnet-base-v2/1'

visual_embeddings_folder_indexed = f'visual_embeddings_indexed_{args.batch_size}/vit-base-patch16-224'
textual_embeddings_folder_indexed = f'textual_embeddings_indexed_{args.batch_size}/sentence_transformers/sentence-transformers/all-mpnet-base-v2/1'
