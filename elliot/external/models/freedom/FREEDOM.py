...
class FREEDOM(RecMixin, BaseRecommenderModel):
    ...
    def __init__(self, data, config, params, *args, **kwargs):
        ...
        self._params_list = [
            ...
            ("_extractor", "extractor", "extractor", None, str, None),
        ...
        self._model = FREEDOMModel(
            ...
            learning_rate=self._learning_rate,
            embed_k=self._factors,
            embed_k_multimod=self._factors,
            l_w=self._l_w,
            rows=row,
            cols=np.array([c - self._num_users for c in col]),
            modalities=self._modalities,
    ...
    def get_recommendations(self, k: int = 100):
        ...
        self._model.eval()
        with torch.no_grad():
            # convert adj matrix to compatible torch sparse tensor to perform the mm operation
